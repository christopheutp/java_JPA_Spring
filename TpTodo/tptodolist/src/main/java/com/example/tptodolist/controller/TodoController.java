package com.example.tptodolist.controller;


import com.example.tptodolist.entity.Todo;
import com.example.tptodolist.service.TodoService;
...
public class TodoController {
    ...
    @GetMapping("{status}")
    public List<Todo> get(@PathVariable boolean status) { return _todoService.getByStatus(status);}
